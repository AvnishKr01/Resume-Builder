export const landingPageStyles = {
  ...
  // Hero section
  heroSection: "max-w-6xl mx-auto sm:px-6 lg:py-12 sm:py-20",
  ...
  headingText: "block text-slate-900 text-6xl",
  headingGradient: "block bg-gradient-to-r from-violet-600 via-fuchsia-600 to-orange-500 bg-clip-text text-transparent text-6xl",
  description: "text-base sm:text-lg lg:text-md text-slate-600 leading-relaxed max-w-lg font-medium",
...
export const cardStyles = {
  ...
  profileCard: "flex items-center gap-3 px-2 py-1 sm:bg-white backdrop-blur-xl border border-gray-200 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.03]",
  profileInitialsContainer: "w-5 h-5 sm:w-8 sm:h-8 bg-gradient-to-br from-violet-500 to-fuchsia-500 rounded-2xl flex items-center justify-center shadow-md",
  profileInitialsText: "text-xs sm:text-lg font-black text-white",
