...
import { ArrowRight, Download, LayoutTemplate, LayoutTemplateIcon, Menu, X, Zap } from 'lucide-react';
                    ...
                    <div className={landingPageStyles.heroGrid}>
                        ...
                        <div className={landingPageStyles.heroLeft}>
                            ...
                            <p className={landingPageStyles.description}>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta suscipit vel quae reiciendis ea recusandae nisi qui deleniti excepturi perferendis et, quam ex, rerum similique quo laborum a. Facere, ex.
                            </p>
                    ...
                    <div className={landingPageStyles.featuresContainer}>
                        <div className={landingPageStyles.featuresHeader}>
                            ...
                            <p className={landingPageStyles.featuresDescription}>
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Pariatur deserunt ex optio nisi debitis sequi.
                            </p>
                        </div>
                        <div className={landingPageStyles.featuresGrid}>
                            {[
                                ...
                                <div key={index} className={landingPageStyles.featureCard}>
                                    ...
                                    <div className={`${landingPageStyles.featureCardContent} ${Ele.bg}`}>
                                        <div className={`${landingPageStyles.featureIconContainer} ${Ele.gradient}`}>
                                            {Ele.icon}
                                        </div>
                                        <h3 className={landingPageStyles.featureTitle}>
                                            {Ele.title}
                                        </h3>
                                        <p className={landingPageStyles.featureDescription}>{Ele.description}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
            ...
            <footer className={landingPageStyles.footer}>
                <div className={landingPageStyles.footerContainer}>
                    <p className={landingPageStyles.footerText}>
                        ...
                        <a href="#" target='_blank' className={landingPageStyles.footerLink}> avi digital services</a>
                    </p>
                </div>
            </footer>
